...
extern const signed short int C_UTILS_SUCCESS      ; /* C-Utils success constant.                       */
extern const signed short int C_UTILS_FAILURE      ; /* C-Utils failure constant.                       */
...
/* Standardization: */
extern const signed long int C_UTILS_MACHINE_BITS  ; /* Machine bits constant.                          */
