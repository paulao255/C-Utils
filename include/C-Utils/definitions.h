...
/* Terminal colors: */
extern const unsigned char *const C_UTILS_BASE_TERMINAL     ; /* Reset terminal text constant.                 */
extern const unsigned char *const C_UTILS_BOLD              ; /* Bold terminal text constant.                  */
extern const unsigned char *const C_UTILS_BASE_TERMINAL_BOLD; /* Reset and bold terminal text constant.        */
extern const unsigned char *const C_UTILS_ITALIC            ; /* Italic terminal text constant.                */
extern const unsigned char *const C_UTILS_UNDERLINE         ; /* Underline terminal text constant.             */
extern const unsigned char *const C_UTILS_BLACK_COLOR       ; /* Black terminal text constant.                 */
extern const unsigned char *const C_UTILS_RED_COLOR         ; /* Red terminal text constant.                   */
extern const unsigned char *const C_UTILS_GREEN_COLOR       ; /* Green terminal text constant.                 */
extern const unsigned char *const C_UTILS_YELLOW_COLOR      ; /* Yellow terminal text constant.                */
extern const unsigned char *const C_UTILS_BLUE_COLOR        ; /* Blue terminal text constant.                  */
extern const unsigned char *const C_UTILS_MAGENTA_COLOR     ; /* Magenta terminal text constant.               */
extern const unsigned char *const C_UTILS_CYAN_COLOR        ; /* Cyan terminal text constant.                  */
extern const unsigned char *const C_UTILS_WHITE_COLOR       ; /* White terminal text constant.                 */
