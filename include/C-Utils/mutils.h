...
float c_utils_summation_f(const float (*f)(float i), signed long int index, const signed long int end);                    /* Summation function using float values.                                  */
...
double c_utils_summation_d(const double (*f)(double i), signed long int index, const signed long int end);                 /* Summation function using double values.                                 */
...
long double c_utils_summation_ld(const long double (*f)(long double i), signed long int index, const signed long int end); /* Summation function using long double values.                            */
