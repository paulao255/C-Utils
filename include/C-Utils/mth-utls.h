...
C_UTILS_API const c_utils_float32_t C_UTILS_MATH_PI_FLOAT32;

/* C-Utils Euler constant using a 32 bits float type. */
C_UTILS_API const c_utils_float32_t C_UTILS_MATH_E_FLOAT32;

/* C-Utils PI constant using a 64 bits float type. */
C_UTILS_API const c_utils_float64_t C_UTILS_MATH_PI_FLOAT64;

/* C-Utils Euler constant using a 64 bits float type. */
C_UTILS_API const c_utils_float64_t C_UTILS_MATH_E_FLOAT64;
