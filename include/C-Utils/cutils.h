...
signed int c_utils_linear_unsigned_char_search(const char *const array, const size_t count, const char target);                                        /* Linear unsigned char search function.               */
...
signed int c_utils_linear_unsigned_array_search(const char *const *const array, const size_t count, const char *const target);                         /* Linear array search function.                       */
signed int c_utils_thread_create(c_utils_thread_t *thread, C_UTILS_THREAD_FUNCTION (*function)(void *arguments), void *arguments);                     /* Thread create function.                             */
