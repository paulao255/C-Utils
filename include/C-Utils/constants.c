...
const signed long int C_UTILS_FULL_VERSION            = 20260421L                                   ; /* C Utils full version constant.                */
...
const signed long int C_UTILS_PATCH_VERSION           = 21L                                         ; /* C Utils patch version constant.               */
