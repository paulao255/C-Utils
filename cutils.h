...
#define C_UTILS_FULL_VERSION 153.0L           /* C Utils full version variable (1.5.3).           */
#define C_UTILS_MAJOR_VERSION  1.0L           /* C Utils major version variable (1).              */
#define C_UTILS_MINOR_VERSION  5.0L           /* C Utils minor version variable (5).              */
#define C_UTILS_PATCH_VERSION  3.0L           /* C Utils patch version variable (3).              */
